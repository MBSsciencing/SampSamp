...
handles.saveDir.String = 'C:\SaveDataEphys'; % MBS change 2025Jul - quality of life.
...
trigOrNot_Callback([], [], handles);  % Ensure trigger GUI state and properties are synced - tere was a bug that stopped recording showing if you have notrig saved in app
